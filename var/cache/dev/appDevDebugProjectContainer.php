...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Fvhjsnavgi', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YtATcrNBZA', 0, 'EBrmLuB0I-9vIetixDUvhg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9rqwBJyxdF', 0, 'EBrmLuB0I-9vIetixDUvhg', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HFfxpuda53', 0, 'EBrmLuB0I-9vIetixDUvhg', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'ecommerce-symfony3', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Ecommerce\\EcommerceBundle\\Resources\\config\\doctrine') => 'Ecommerce\\EcommerceBundle\\Entity', ($this->targetDirs[3].'\\src\\Pages\\PagesBundle\\Resources\\config\\doctrine') => 'Pages\\PagesBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Ecommerce\\EcommerceBundle\\Entity');
        $b->addDriver($a, 'Pages\\PagesBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\MyUser\\UtilisateurBundle\\Entity'))), 'MyUser\\UtilisateurBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('EcommerceEcommerceBundle' => 'Ecommerce\\EcommerceBundle\\Entity', 'PagesPagesBundle' => 'Pages\\PagesBundle\\Entity', 'MyUserUtilisateurBundle' => 'MyUser\\UtilisateurBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c10d12d30b02e0d7e5334113918e1a2c1a60c57c0f61f1d43fdb05642137ff88');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MyUser\\UtilisateurBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('williamsviyou97@gmail.com' => 'williamsviyou97@gmail.com'), 'resetting' => array('williamsviyou97@gmail.com' => 'williamsviyou97@gmail.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MyUser\\UtilisateurBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MyUser\\UtilisateurBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MyUser\\UtilisateurBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'MyUser\\UtilisateurBundle\\Entity\\User');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('williamsviyou97@gmail.com');
        $a->setPassword('17maiwilliams');
        $a->setAuthMode(NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Ecommerce\EcommerceBundle\Twig\Extension\TVAExtension());
        $instance->addExtension(new \Ecommerce\EcommerceBundle\Twig\Extension\MontantTvaExtension());
        $instance->addExtension($this->get('knp_paginator.twig.extension.pagination'));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension($this->get('var_dumper.cloner')));
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension());
        $instance->addGlobal('app', $c);
        $instance->addGlobal('telephone', '07 52 94 06 01');
        $instance->addGlobal('fax', '02 95 63 98 71');
        $instance->addGlobal('adresse', 'Paris 95 000 -16 rue De Lafolie');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MyUser\\UtilisateurBundle/Resources/views'), 'MyUserUtilisateur');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ods842fsf5592b8452166qqdsd147');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyUserUtilisateurBundle' => 'MyUser\\UtilisateurBundle\\MyUserUtilisateurBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'MyUserUtilisateurBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MyUser\\UtilisateurBundle'),
                    'namespace' => 'MyUser\\UtilisateurBundle',
                ),
            ...
            'database_port' => 3306,
            'database_name' => 'ecommerce-symfony3',
            'database_user' => 'root',
            'database_password' => '',
            'mailer_transport' => 'smtp',
            'mailer_encryption' => 'ssl',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'williamsviyou97@gmail.com',
            'mailer_password' => '17maiwilliams',
            'secret' => 'ods842fsf5592b8452166qqdsd147',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'ods842fsf5592b8452166qqdsd147',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'williamsviyou97@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '17maiwilliams',
            ...
            'fos_user.model.user.class' => 'MyUser\\UtilisateurBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'williamsviyou97@gmail.com' => 'williamsviyou97@gmail.com',
            ),
